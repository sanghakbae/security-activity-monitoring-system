              ...
              <div className="flex items-center gap-3">
                <div className="min-w-0 flex-1">
                  <div className="mb-1.5 flex items-center gap-2">
                    <span className="shrink-0 rounded-lg bg-slate-200 px-2 py-0.5 text-[11px] font-semibold leading-none text-slate-800">
                      {item.frequencyLabel}
                    </span>

                    <span
                      className={`shrink-0 rounded-lg px-2 py-0.5 text-[11px] font-semibold leading-none ${getStatusStyle(
                        item.status,
                      )}`}
                    >
                      {item.status}
                ...
                {item.status === '완료' && (
                  <div className="flex shrink-0 items-center justify-center gap-1.5 rounded-xl border border-emerald-200 bg-emerald-50 px-2.5 py-2 text-emerald-700">
